...
{
    internal abstract class RecordRepoBaseService<T, TId, TQuery, TRepo> where TRepo : IRecordRepository<T, TId, TQuery> where TId : class where T : class, IHasId<TId> where TQuery : QueryRequest, new()
    {
